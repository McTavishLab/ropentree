...
So, we will need to link the tip taxon labels with the complete scientific name, as provided on a supplementary table from the original publication.

To do this, first read the csv file linking tip taxon labels with the complete scientific taxon names using the `read.csv` function:
